...
export const useMappingResources = (plan: V1beta1Plan): MappingResources => {
  ...
  return {
    ...
    resourcesError:
      Boolean(providersLoadError) ||
      Boolean(networkMapsError) ||
      Boolean(storageMapsError) ||
      Boolean(sourceNetworksError) ||
      Boolean(targetNetworksError) ||
      Boolean(sourceStoragesError) ||
      Boolean(targetStoragesError),
