...
const LearningExperiencePanel: FC<Props> = ({ setIsDrawerOpen, topics }) => {
  const { t } = useForkliftTranslation();
  const [selectedTopic, setSelectedTopic] = useState<LearningExperienceTopic | undefined>();

  return (
    <DrawerPanelContent isResizable className="pfext-quick-start__base">
      ...
      <DrawerPanelBody className="pfext-quick-start-panel-content__body forklift--learning">
        {selectedTopic ? (
