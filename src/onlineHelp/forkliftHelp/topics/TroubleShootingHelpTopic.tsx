...
const troubleShootingHelpTopics: LearningExperienceSubTopic[] = [
  {
    ...
    subListStyleType: 'decimal',
    subTopics: [
      {
        id: 'migration-progress',
        subListStyleType: 'disc',
        subTopics: [
          {
