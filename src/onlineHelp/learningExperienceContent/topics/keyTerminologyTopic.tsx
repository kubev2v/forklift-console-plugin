...
import { OCP_GUIDE_URL } from './utils/constants';

// eslint-disable-next-line max-lines-per-function
const keyTerminologySubTopics = (): LearningExperienceSubTopic[] => [
  {
    expandable: true,
      ...
      <ForkliftTrans>
        <Content>
          <Content component="p">
            ...
            <ExternalLink href={OCP_GUIDE_URL} isInline>
...
export const keyTerminologyTopic: LearningExperienceTopic = {
  description: t('Understand OpenShift more with definitions to essential vocabulary.'),
  icon: <CatalogIcon />,
  id: 'key-terminology',
  subListStyleType: ListStyleType.DESCRIPTIONS,
  subTopics: keyTerminologySubTopics,
