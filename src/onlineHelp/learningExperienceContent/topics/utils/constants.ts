...
import { createStorageMapTopic } from '../createStorageMapTopic/createStorageMapTopic';
import { migratingVMsTopic } from '../migratingVMsTopic/migratingVMsTopic';
import { migrationOptimizationTopic } from '../migrationOptimizationTopic';
...
export const MigrationSourceTypeLabels = {
  ...
  [PROVIDER_TYPES.nutanix]: t('Nutanix AHV'),
...
export const learningExperienceTopics: LearningExperienceTopic[] = [
  ...
  migratingVMsTopic,
  migrationTypeTopic,
  createNetworkMapTopic,
  createStorageMapTopic,
  migrationOptimizationTopic,
