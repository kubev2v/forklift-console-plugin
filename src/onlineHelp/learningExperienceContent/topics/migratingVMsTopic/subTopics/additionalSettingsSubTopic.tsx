...
const ADDITIONAL_SETTINGS_SUB_TOPIC_ID = 'migration-additional-settings';

export const additionalSettingsSubTopic = (): LearningExperienceSubTopic => ({
  id: ADDITIONAL_SETTINGS_SUB_TOPIC_ID,
  subListStyleType: ListStyleType.LOWER_ALPHA,
  subTopics: () => [
    {
      id: `${ADDITIONAL_SETTINGS_SUB_TOPIC_ID}-a`,
      title: (
        <HelpTitledContent
    ...
    {
      id: `${ADDITIONAL_SETTINGS_SUB_TOPIC_ID}-b`,
      title: (
        <HelpTitledContent
    ...
    {
      id: `${ADDITIONAL_SETTINGS_SUB_TOPIC_ID}-c`,
      title: (
        <HelpTitledContent
    ...
    {
      id: `${ADDITIONAL_SETTINGS_SUB_TOPIC_ID}-d`,
      title: (
        <HelpTitledContent
          title={t('Root device')}
          content={t(
    ...
    {
      id: `${ADDITIONAL_SETTINGS_SUB_TOPIC_ID}-e`,
      title: (
        <HelpTitledContent
    ...
    {
      id: `${ADDITIONAL_SETTINGS_SUB_TOPIC_ID}-f`,
      title: (
        <HelpTitledContent
          title={t('Add hooks')}
          content={t(
