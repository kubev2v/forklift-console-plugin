...
import { LEARN_MORE_MIGRATION_TYPE_DOCS_URL } from './utils/constants';

const migrationTypeSubTopics = (): LearningExperienceSubTopic[] => [
  {
    expandable: true,
