...
describe('TypeaheadSelect', () => {
  ...
  describe('Rendering', () => {
    ...
    test('renders as disabled when isDisabled is true', async () => {
      ...
      const input = screen.getByRole('combobox');
      const toggleButton = screen.getByRole('button', { name: /menu toggle/iu });
...
describe('TypeaheadSelect - Selection Clearing', () => {
  ...
  test('shows clear button when allowClear is true and value is selected', async () => {
    ...
    const clearButton = screen.getByRole('button', { name: /clear/iu });
...
describe('TypeaheadSelect - Messages and Navigation', () => {
  setupTest();
