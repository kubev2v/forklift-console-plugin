...
TEMPLATE=https://raw.githubusercontent.com/kubev2v/forklift-console-plugin/main/ci/yaml/forklift-plugin-dev.tpl.yaml
...
Note:
Running virtualized workloads (e.g. virtual machines) on this cluster requires starting the cluster using the root user (e.g. `sudo bash ci/deploy-cluster.sh`)
