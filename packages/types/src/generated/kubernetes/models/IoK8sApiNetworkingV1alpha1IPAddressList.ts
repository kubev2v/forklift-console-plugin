...
} from './IoK8sApiNetworkingV1alpha1IPAddress';
...
/**
 * Check if a given object implements the IoK8sApiNetworkingV1alpha1IPAddressList interface.
 */
export function instanceOfIoK8sApiNetworkingV1alpha1IPAddressList(value: object): boolean {
    let isInstance = true;
