...
export interface IoK8sApiAdmissionregistrationV1MutatingWebhook {
     ...
     * @type {Array<string>}
     * @memberof IoK8sApiAdmissionregistrationV1MutatingWebhook
     */
...
/**
 * Check if a given object implements the IoK8sApiAdmissionregistrationV1MutatingWebhook interface.
 */
export function instanceOfIoK8sApiAdmissionregistrationV1MutatingWebhook(value: object): boolean {
    let isInstance = true;
...
export function IoK8sApiAdmissionregistrationV1MutatingWebhookFromJSON(json: any): IoK8sApiAdmissionregistrationV1MutatingWebhook {
    return IoK8sApiAdmissionregistrationV1MutatingWebhookFromJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1MutatingWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1MutatingWebhook {
...
export function IoK8sApiAdmissionregistrationV1MutatingWebhookToJSON(value?: IoK8sApiAdmissionregistrationV1MutatingWebhook | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
