...
} from './IoK8sApiFlowcontrolV1beta3PriorityLevelConfiguration';
...
/**
 * Check if a given object implements the IoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationList interface.
 */
export function instanceOfIoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationList(value: object): boolean {
    let isInstance = true;
...
export function IoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationListFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationList {
