 ...
 */
export function instanceOfIoK8sApiAuthorizationV1SubjectAccessReview(value: object): boolean {
    let isInstance = true;
...
export function IoK8sApiAuthorizationV1SubjectAccessReviewToJSON(value?: IoK8sApiAuthorizationV1SubjectAccessReview | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
