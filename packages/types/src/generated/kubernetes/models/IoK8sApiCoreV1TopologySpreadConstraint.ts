...
/**
 * Check if a given object implements the IoK8sApiCoreV1TopologySpreadConstraint interface.
 */
export function instanceOfIoK8sApiCoreV1TopologySpreadConstraint(value: object): boolean {
    let isInstance = true;
...
export function IoK8sApiCoreV1TopologySpreadConstraintFromJSON(json: any): IoK8sApiCoreV1TopologySpreadConstraint {
    return IoK8sApiCoreV1TopologySpreadConstraintFromJSONTyped(json, false);
}

export function IoK8sApiCoreV1TopologySpreadConstraintFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiCoreV1TopologySpreadConstraint {
...
export function IoK8sApiCoreV1TopologySpreadConstraintToJSON(value?: IoK8sApiCoreV1TopologySpreadConstraint | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
