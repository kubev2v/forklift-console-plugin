...
} from './IoK8sApiAdmissionregistrationV1alpha1ParamRef';
...
/**
 * Check if a given object implements the IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyBindingSpec interface.
 */
export function instanceOfIoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyBindingSpec(value: object): boolean {
    let isInstance = true;
