...
/**
 * Check if a given object implements the IoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperations interface.
 */
export function instanceOfIoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperations(value: object): boolean {
    let isInstance = true;
