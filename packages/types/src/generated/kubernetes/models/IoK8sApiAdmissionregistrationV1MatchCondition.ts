...
/**
 * Check if a given object implements the IoK8sApiAdmissionregistrationV1MatchCondition interface.
 */
export function instanceOfIoK8sApiAdmissionregistrationV1MatchCondition(value: object): boolean {
    let isInstance = true;
