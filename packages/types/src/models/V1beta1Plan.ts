...
import {
    V1beta1PlanSpecFromJSON,
    V1beta1PlanSpecFromJSONTyped,
    V1beta1PlanSpecToJSON,
} from './V1beta1PlanSpec';
import type { V1beta1PlanStatus } from './V1beta1PlanStatus';
import {
    V1beta1PlanStatusFromJSON,
    V1beta1PlanStatusFromJSONTyped,
    V1beta1PlanStatusToJSON,
} from './V1beta1PlanStatus';
