...
export const TypeDetailsItem: React.FC<ProviderDetailsItemProps> = ({
  ...
  const defaultMoreInfoLink =
    'https://access.redhat.com/documentation/en-us/migration_toolkit_for_virtualization/2.6/html-single/installing_and_using_the_migration_toolkit_for_virtualization/index#adding-providers';
