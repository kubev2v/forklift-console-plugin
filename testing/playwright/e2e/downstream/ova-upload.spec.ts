...
import { NfsCleanupManager } from '../../utils/nfs-cleanup';
...
test.describe('OVA Provider Upload Tests', { tag: '@downstream' }, () => {
  ...
  test('should create OVA provider with applianceManagement enabled and validate upload form', async ({
    ...
    let providerDetailsPage: ProviderDetailsPage | null = null;
    ...
    const uniqueOvaFileName = `test-${uniqueId}-2nd_disk_v3.ova`;
