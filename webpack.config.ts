...
import extensions from './packages/forklift-console-plugin/console-extensions';
import pluginMetadata from './packages/forklift-console-plugin/plugin';
import { DynamicConsoleRemotePlugin } from './packages/webpack/src';
